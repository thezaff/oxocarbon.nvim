...
vim.api.nvim_set_hl(0, "NeoTreeGitDeleted", { fg = oxocarbon.base12 })
vim.api.nvim_set_hl(0, "NeoTreeGitIgnored", { fg = oxocarbon.base02 })
vim.api.nvim_set_hl(0, "NeoTreeGitModified", { fg = oxocarbon.base14 })
...
vim.api.nvim_set_hl(0, "NeoTreeTabActive", { fg = oxocarbon.base15 })

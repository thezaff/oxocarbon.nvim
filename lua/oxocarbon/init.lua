...
vim.api.nvim_set_hl(0, "ModesCopy", { bg = oxocarbon.base13 })
vim.api.nvim_set_hl(0, "ModesDelete", { bg = oxocarbon.base10 })
vim.api.nvim_set_hl(0, "ModesInsert", { bg = oxocarbon.base14 })
vim.api.nvim_set_hl(0, "ModesVisual", { bg = oxocarbon.base15 })
-- Transparency

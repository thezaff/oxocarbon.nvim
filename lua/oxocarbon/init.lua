...
vim.api.nvim_set_hl(0, "NeoTreeGitConflict", { fg = oxocarbon.base08 })
vim.api.nvim_set_hl(0, "NeoTreeGitDeleted", { fg = oxocarbon.base08 })
vim.api.nvim_set_hl(0, "NeoTreeGitIgnored", { fg = oxocarbon.base02 })
vim.api.nvim_set_hl(0, "NeoTreeGitModified", { fg = oxocarbon.base10 })
vim.api.nvim_set_hl(0, "NeoTreeGitUnstaged", { fg = oxocarbon.base08 })
vim.api.nvim_set_hl(0, "NeoTreeGitUntracked", { fg = oxocarbon.base14 })
vim.api.nvim_set_hl(0, "NeoTreeGitStaged", { fg = oxocarbon.base11 })
...
vim.api.nvim_set_hl(0, "NeoTreeTabActive", { fg = oxocarbon.base07 })
